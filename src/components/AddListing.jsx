...
const AddListing = () => {
    ...
    return (
        <div>
            ...
            <h1 className='text-4xl text-primary text-center font-bold mt-10'>Add Listing</h1>
            <form onSubmit={handleAddListing} className="space-y-4 max-w-xl mx-auto p-6 shadow rounded">
                {/* Name */}
                <div>
                ...
                {/* Submit Button */}
                <button className="btn bg-accent w-full">Submit</button>
            </form>
        </div>
    );
};
