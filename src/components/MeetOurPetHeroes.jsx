            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-14">
                    <h2 className="text-3xl md:text-4xl font-bold text-base-content">
                        Meet Our <span className="text-accent">Pet Heroes</span>
                    </h2>
                    <p className="mt-4 text-base-content/70 max-w-2xl mx-auto">
                        Discover the stories of our amazing pets and the people who care for them, inspiring love and joy every day.
                    </p>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 overflow-x-hidden gap-6">
                    {vets.map(vet => (
                        <div
                            key={vet.vetId}
